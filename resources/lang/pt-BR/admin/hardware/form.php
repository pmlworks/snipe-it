...
return [
    ...
    'asset_not_deployable_checkin' => 'Esse status do ativo não é implantável. Usando este rótulo de status irá checar o ativo.',
    'asset_deployable' => 'Este ativo pode ser atribuído.',
