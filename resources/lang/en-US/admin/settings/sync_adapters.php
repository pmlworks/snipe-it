...
return [
    ...
    'push_complete' => 'Push complete. Pushed :count asset(s), skipped :skipped, :errors error(s).',
    ...
    'clone_button' => 'Clone this adapter',
    'clone_modal_title' => 'Clone sync adapter',
    'clone_label_default' => 'Copy of :label',
    'clone_label_help' => 'Give the new adapter a distinct label. URL, credentials, and mapping are copied over. You can tweak them after saving.',
    'instance_cloned' => 'Adapter cloned from ":label". Review the copied settings, adjust the company if needed, then check "Active" and Save.',
    'company_filter_prefix' => 'Viewing adapters for:',
    ...
    'target_native_byod' => 'BYOD (personal device)',
    ...
    'abm_private_key_invalid' => 'This does not look like a valid private key file. Check that the first and last lines start with five dashes and that nothing was cut off when pasting.',
    'abm_private_key_unsupported' => 'This is a valid key, but it is not the format Apple Business Manager uses. Download a fresh key from your Apple Business Manager console (Settings -> API) and paste that instead. Apple only lets you download each key once, so create a new API key entry rather than trying to re-download an existing one.',
    ...
    */
    ...
    'abm_extra_device_capacity' => 'AxM Storage Capacity',
    'abm_extra_wifi_mac' => 'AxM Wi-Fi MAC',
    'abm_extra_bluetooth_mac' => 'AxM Bluetooth MAC',
    'abm_extra_ethernet_mac' => 'AxM Ethernet MAC',
    'abm_extra_imei' => 'AxM IMEI',
    'abm_extra_meid' => 'AxM MEID',
    'abm_extra_eid' => 'AxM EID',
    'abm_extra_added_to_org' => 'AxM Added to Org',
