...
return [
    ...
    'sign_in_place' => 'Sign in place',
    'sign_in_place_help' => 'Check this box if you have the user present and wish for them to accept the item and sign the EULA (when applicable) right now.',
    'importer' => [
