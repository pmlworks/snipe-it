...
return [
    ...
    'license_expiring_alert' => 'Yra :count licencija, kuri baigsis arba bus nutraukta per ateinančias :threshold dienas.|Yra :count licencijos (-ų), kurios baigiasi arba bus nutrauktos per ateinančias :threshold dienas (-ų).',
    ...
    'name' => 'Pavadinimas',
    'new_item_checked' => 'Jums buvo išduotas naujas daiktas, išsami informacija pateikta žemiau.|Jums buvo išduoti :count nauji (-ų) daiktai (-ų), išsami informacija pateikta žemiau.',
    'new_item_checked_with_acceptance' => 'Jums buvo išduotas naujas daiktas, kurio gavimą reikia patvirtinti, išsami informacija pateikta žemiau.|Jums buvo išduoti :count nauji (-ų) daiktai (-ų), kurių gavimą reikia patvirtinti, išsami informacija pateikta žemiau.',
